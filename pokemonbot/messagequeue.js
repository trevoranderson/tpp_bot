// timed function queue. Runs a maximum of 1 function per max frequency. EmptyCB called when queue had an active wait, but then emptied itself
module.exports = function (maxfreq, emptyCB) {
